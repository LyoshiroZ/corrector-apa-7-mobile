...
class CorrectorApp(MDApp):
    ...
    def _abrir_menu_plantillas(self):
        ...
        for nombre, datos in PLANTILLAS_APA.items():
            ...
            fila.bind(on_release=lambda _w, n=nombre:
        ...
        scroll = MDScrollView(size_hint=(1, None), height=dp(420))
        scroll.add_widget(contenido)
    ...
    def _descargar_plantilla(self, nombre: str):
        ...
        try:
            ...
            with open(ruta, "wb") as f:
                f.write(data)
            self._snack(f"📥 Plantilla guardada en Descargas: "
                        f"{os.path.basename(ruta)}")
        except Exception as e:
            self._snack(f"No se pudo crear la plantilla: {e}")
