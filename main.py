...
class CorrectorApp(MDApp):
    ...
    def _collapsible(self, titulo: str, color, build):
        """Card colapsable: header con chevron + contenido add/remove."""
    ...
    def _contenido_ejemplos(self, _color):
        """Lista inline de ejemplos APA (libro, artículo, web, cita)."""
        cont = MDBoxLayout(
            orientation="vertical",
            spacing=dp(8),
            size_hint_y=None,
