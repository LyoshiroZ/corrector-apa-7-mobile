...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<View>(R.id.fab_plantillas).setOnClickListener {
            startActivity(Intent(this, PlantillasActivity::class.java))
        }

        findViewById<View>(R.id.fab_chat).setOnClickListener {
            startActivity(Intent(this, ChatActivity::class.java))
        }

        findViewById<View>(R.id.btn_plantillas_offline).setOnClickListener {
            startActivity(Intent(this, PlantillasActivity::class.java))
        }
    }
